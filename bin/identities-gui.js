...
var _IDPList = require('./components/IDPList');
...
},{"./components/DefaultIdentity":28,"./components/IDPList":29,"./components/IdentityList":31,"react":26,"react-dom":23}],28:[function(require,module,exports){
'use strict';
...
var IDPList = function (_Component) {
  _inherits(IDPList, _Component);

  function IDPList(props) {
    _classCallCheck(this, IDPList);

    var _this = _possibleConstructorReturn(this, (IDPList.__proto__ || Object.getPrototypeOf(IDPList)).call(this, props));

    console.log(_this.props.idps);
    return _this;
  }

  _createClass(IDPList, [{
    key: 'render',
    value: function render() {
      var _this2 = this;
...
},{"./IDPSingle":30,"react":26}],30:[function(require,module,exports){
'use strict';
...
var IDPSingle = function (_Component) {
  _inherits(IDPSingle, _Component);
  ...
  **/
  ...
  _createClass(IDPSingle, [{
    key: 'handleClick',
    value: function handleClick(idp) {
      var _this2 = this;
    ...
    value: function render() {
      ...
      **/
      ...
      return _react2.default.createElement(
        'div',
        { className: 'idp-single' },
        _react2.default.createElement(
          'a',
          { id: "link-" + key.domain, 'data-idp': key.domain, className: 'mdc-list-item link-' + key.domain, href: '#',
...
},{"./IdentitySingle":32,"react":26}],32:[function(require,module,exports){
'use strict';
